...
Self-hosted bilingual web companion for a MeshCore USB Companion Radio on Raspberry Pi.
...
Current release: **0.3.0**. Target platform: **Raspberry Pi OS Bookworm**, 32-bit or
