...
Current release: **0.9.0**. Target platform: **Raspberry Pi OS Bookworm**, 32-bit or
...
Version 0.9.0 adds per-node link-quality analytics, a unified station-health dashboard,
Raspberry Pi power diagnostics, encrypted scheduled backups, global message search and
a privacy-filtered support report. Outbound messages now follow MeshCore's 133-character
limit. See the RU/EN guides and release notes for migration and recovery details.
